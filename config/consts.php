...
return [
	...
	'MESSAGES' => [
        ...
        'SETTLEMENT_1MONTH' => '読書認定書（パスコード %s) の閲覧期間は「%s」までです。延長する必要がある場合はマイ書斎の読書認定書発行欄からお手続きください。',
        ...
        'ASSOCIATE_MEMBER_ALERT' => '現在、準会員です。読Ｑを採用している団体に所属するか、または「新規登録」にて、もとの読Ｑネームを入力して入会申込をすると、正会員となり受検ができるようになります。',
