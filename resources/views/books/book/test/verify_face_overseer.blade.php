                ...
                if(response.status == 'success'){
                    ...
                    setTimeout(function(){
                        if(mode == 3){
                            ...
                            $.ajax({
                                type: "post",
                                url: "{{url('/book/regTestSuccessGeneral')}}",
                                data: info,
        ...
        @if(isset($mode))
            @if($mode==3)
                <form action="" method="post" id="success_form">
                    {{csrf_field()}}
                    <input type="hidden" name="book_id" id="book_id" value="{{$bookId}}"/>
                    <input type="hidden" name="passed_quiz_count" value="{{$passed_quiz_count}}" id="quiz_count"/>
                    <input type="hidden" name="passed_point" id="passed_point" value="{{$passed_point}}"/>
                    <input type="hidden" name="page_count" id="page_count" value="{{$page_count}}"/>
                    <input type="hidden" name="passed_test_time" id="passed_test_time" value="{{$passed_test_time}}">
                </form>
            @endif
        @endif
        <div id="face">
