...
@section('contents')
	<div class="page-content-wrapper">
		...
		@endif
			...
			<div class="row">
				<div class="offset-md-2 col-md-10">
					<div class="form-body h4"  style="color:red; line-height: 1.1">
					問題文の<span style='text-decoration:underline !important'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>線のひいてあるところが本の内容と合っていれば①、ちがっていれば②を選んで「次へ」をクリックしてください。
					</div>
				</div>
			</div>
			<div class="form-body text-md-center col-xs-12" style="text-align:center;">
