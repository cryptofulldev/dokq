...
$(document).ready(function(){
    ...
    $(".btn-next").click(function(){
        ...
        $("#verify_form").attr("action",'{{url("/auth/signin_teacher")}}');
        $("#verify_form").submit();
    });
            ...
            <div id="face">
                ...
                <div class="form-group row" >
                    <div class="col-md-12 text-md-right verify-exit hide">
                        <label class="control-label font-red" @if(isset($user) && $user->active >= 3) disabled @endif>認証完了</label>
                    </div>
                </div>
                <div class="form-group row" >
                    ...
                    <div class="col-md-3 text-md-center col-xs-3" style="text-align:center;">
                        <button type="button" class="btn btn-warning btn-verify" @if(isset($user) && $user->active >= 3) disabled @endif>顔認証</button>
                    </div>
                    <div class="col-md-6 text-md-right col-xs-6" style="text-align:right;">
                        <button type="button" class="btn btn-success btn-failed"  @if(isset($user) && $user->active >= 3) disabled @endif>顔認証エラーになる場合</button>
                    </div>
                </div>
                <div class="form-group row">
