    ...
    <?php endif; ?>
	<div class="form-body">
		<h4 class="form-section warning"><strong><?php if(isset($book)): ?> 本の基本情報を編集 <?php else: ?> 本の基本情報を入力します <?php endif; ?></strong></h4>
		<div class="row top-border">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('title') ? ' has-danger' : ''); ?>">
				...
				<div class="col-md-5">
					<input type="text" name="title" value="<?php echo e(old('title')!='' ? old('title'):( isset($book)? $book->title: '')); ?>" class="form-control" id="input_1" placeholder="雪国">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('title_furi') ? ' has-danger' : ''); ?>">
				...
				<div class="col-md-5">
					<input type="text" name="title_furi" value="<?php echo e(old('title_furi')!='' ? old('title_furi'): (isset($book)? $book->title_furi: '')); ?>" class="form-control" placeholder="ゆきぐに" id="input_2">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('isbn') ? ' has-danger' : ''); ?>">
				...
				<div class="col-md-5">
					<input type="text" name="isbn" id="input_5" value="<?php echo e(old('isbn')!='' ? old('isbn'): (isset($book)? $book->isbn: '')); ?>" class="form-control" placeholder="410100101">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('publish') ? ' has-danger' : ''); ?>">
				...
				<div class="col-md-5">
					<input type="text" name="publish" value="<?php echo e(old('publish') ? old('publish'): (isset($book)? $book->publish: '')); ?>" class="calc form-control" maxlength="128"  id="input_6" placeholder="新潮文庫">
				...
				<div class="col-md-5">
					<select class="form-control select2me calc" name="categories[]" id="categories[]" multiple placeholder="選択..." style="min-width:100px;">
						...
						<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if((is_object(old('categories')) && count(get_object_vars(old('categories'))) > 0) || (is_array(old('categories')) && count(old('categories'))) > 0): ?>
								<option value="<?php echo e($category->id); ?>" <?php if(in_array((string)$category->id,  old('categories'))): ?> selected <?php endif; ?>><?php echo e($category->name); ?></option>
				...
				<div class="col-md-5">
					<select name="recommend" class="form-control select2me calc"  placeholder="選択..." style="height:33px !important">
						...
						<?php $__currentLoopData = config('consts')['BOOK']['RECOMMEND']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $recommend): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($key); ?>" <?php if($key==old('recommend')): ?> selected <?php endif; ?> <?php if(isset($book->recommend)&&($book->recommend==$key)): ?> selected <?php endif; ?>><?php echo e($recommend['TITLE']); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
			...
			<div class="col-md-12  margin-bottom-5">
				...
				<div class="col-md-5">
					<textarea id="image_url" name="image_url" rows="3" style="width: 100%"><?php echo e((isset($book)? $book->image_url: '')); ?></textarea>
				</div>
			</div>
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('url') ? ' has-danger' : ''); ?>">
				...
				<div class="col-md-5">
					<textarea id="rakuten_url" name="rakuten_url" rows="3" style="width: 100%"><?php echo e((isset($book)? $book->rakuten_url: '')); ?></textarea>
				</div>
			</div>				
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('url') ? ' has-danger' : ''); ?>">
				<label class="control-label col-md-7 text-md-left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;honto で見る。</strong></label>
				<div class="col-md-5">
					<textarea id="honto_url" name="honto_url" rows="3" style="width: 100%"><?php echo e((isset($book)? $book->honto_url: '')); ?></textarea>
				</div>
			</div>				
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('url') ? ' has-danger' : ''); ?>">
				<label class="control-label col-md-7 text-md-left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;楽天ブックスで見る。</strong></label>
				<div class="col-md-5">
					<textarea id="seven_net_url" name="seven_net_url" rows="3" style="width: 100%"><?php echo e((isset($book)? $book->seven_net_url: '')); ?></textarea>
				</div>
			</div>	
			<?php else: ?>
			<div class="col-md-12  margin-bottom-5">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('pages') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">
					...
					<div class="col-md-9 spin">
						<input type="number" min="0" name="pages" value="<?php echo e(old('pages')!='' ? old('pages'): (isset($book)? $book->pages: '')); ?>" class="param spinner-input form-control" maxlength="3" id="input_8">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('max_rows') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="max_rows" value="<?php echo e(old('max_rows')!='' ? old('max_rows'): (isset($book)? $book->max_rows: '')); ?>" class="param calc form-control" maxlength="3" id="input_9">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('max_chars') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="max_chars" value="<?php echo e(old('max_chars')!='' ? old('max_chars'): (isset($book)? $book->max_chars: '')); ?>" class="param calc form-control" maxlength="3" id="input_10">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('entire_blanks') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="entire_blanks" value="<?php echo e(old('entire_blanks')!='' ? old('entire_blanks'): (isset($book)? $book->entire_blanks: '')); ?>" class="param calc form-control" maxlength="3" id="input_11">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('quarter_filled') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="quarter_filled" value="<?php echo e(old('quarter_filled')!='' ? old('quarter_filled'): (isset($book)? $book->quarter_filled: '')); ?>" class="param calc form-control" maxlength="3" id="input_12">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('half_blanks') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="half_blanks" value="<?php echo e(old('half_blanks')!='' ? old('half_blanks'): (isset($book)? $book->half_blanks: '')); ?>" class="param calc form-control" maxlength="3" id="input_13">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('quarter_blanks') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="quarter_blanks" value="<?php echo e(old('quarter_blanks')!='' ? old('quarter_blanks'): (isset($book)? $book->quarter_blanks: '')); ?>" class="param calc form-control" maxlength="3" id="input_14">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p30') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p30" value="<?php echo e(old('p30')!='' ? old('p30'): (isset($book)? $book->p30: '')); ?>" class="param calc form-control" maxlength="3" id="input_15">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p50') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p50" value="<?php echo e(old('p50')!='' ? old('p50'): (isset($book)? $book->p50: '')); ?>" class="param calc form-control" maxlength="3" id="input_16">
			...
			<div class="col-md-12  margin-bottom-5  <?php echo e($errors->has('p70') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p70" value="<?php echo e(old('p70')!='' ? old('p70'): (isset($book)? $book->p70: '')); ?>" class="param calc form-control" maxlength="3" id="input_17">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p90') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p90" value="<?php echo e(old('p90')!='' ? old('p90'): (isset($book)? $book->p90: '')); ?>" class="param calc form-control" maxlength="3" id="input_18">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p110') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p110" value="<?php echo e(old('p110')!='' ? old('p110'): (isset($book)? $book->p110: '')); ?>" class="param calc form-control" maxlength="3" id="input_19">
		...
		<div class="row">			
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('total_chars') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" value="<?php echo e(old('total_chars')!='' ? old('total_chars'): (isset($book)? $book->total_chars: '')); ?>" name="total_chars" id="total_chars" readonly class="form-control" maxlength="6">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 ">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-9">
					<input type="text" name="point" value="<?php echo e(old('point')!='' ? old('point'): (isset($book)? floor($book->point*100)/100: '')); ?>" readonly="true" class="form-control" id="point">
					</div>
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('register_visi_type') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					...
					<select class="bs-select form-control" name="register_visi_type" placeholder="選択.." style="height:33px !important">
						<?php for($i=1; $i<3; $i++): ?>
							<option value="<?php echo e($i - 1); ?>" <?php if(old('register_visi_type')!=''): ?> <?php if($i-1==old('register_visi_type')): ?> selected <?php endif; ?> <?php else: ?> <?php if(isset($book)): ?> <?php if($book->register_visi_type == $i-1): ?> selected <?php endif; ?> <?php endif; ?> <?php endif; ?>><?php echo e(config('consts')['BOOK']['REGISTER_VISI_TYPE'][$i]); ?></option>
						<?php endfor; ?>
					</select>
