...
<?php $__env->startSection('contents'); ?>
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title font_gogic" style="font-family:HGP明朝B;">クイズを作る際の注意</h3>
							
			<div class="row">
				<div class="col-md-12">
				  	<div class="form">
						<form class="form-horizontal" action="<?php echo e(url('quiz/create')); ?>">
								...
								<div class="row">
									<div class="col-md-5">
										<div class="row test_content">
											<div class="col-sm-1" style="align-self:center">
												<h3 class="book_title font_gogic" style="font-family:HGP明朝B;">出題サンプル</h3>
											</div>
														...
														<div class="row">
															...
															<div class="col-sm-2 quiz_content" style="padding-right:0px;height:420px;">
																<h4 class="font_gogic" style="max-width: 30px;text-align: left;font-family:HGP明朝B;">
																	 <?php 
																	 	$st = "誕生日*たんじょうび*の朝*あさ*、なつみは、#バス#にとびのった｡"; 
															...
															<div class="col-sm-3">
																...
																<div class="row">
																	...
																	<p class="font_gogic" style="writing-mode:vertical-rl;max-width: 5px; text-align:left;margin-left: 15px;writing-mode:vertical-rl !important;font-family:HGP明朝B;"><span style="font-size:0px;color:#fff;">ー</span>taro02412</p>
									...
									<div class="col-md-7">
										<ul class="caution">
											...
											<li>
												③ 傍線部は、#(シャープ)で囲んでください。短い文なら全文を囲んでもかまいません。#が無いと次へ進めません。
											</li>
											<li>
							...
							<div class="form-actions right">
								...
								<a class="btn btn-warning" href="<?php echo e(url('quiz/create?book_id='.$book->id)); ?>">この本のクイズを作る</a>
