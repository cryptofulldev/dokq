					    ...
					    <tbody class="text-md-center">
							...
							<tr class="text-md-center">
								...
								<td class="align-middle">
									...
									<a class="btn btn-email btn-warning" href="<?php echo e(url('/admin/unsubscribe_email/'.$user->id)); ?>" style="padding-top: 0; padding-bottom:0; color: #FFF; font-weight:600">送信</a>
									<?php endif; ?>
								</td>
