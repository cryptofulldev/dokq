			...
			<div class="row">
				<div class="col-md-12">
					<div class="top-news" style="width:320px;height:50px">
						<a class="btn blue" <?php if(Auth::check() && Auth::user()->getWifiFlag() == 0): ?> href="#" <?php else: ?> disabled <?php endif; ?>>
					...
					<div class="news-blocks white">
						...
						<p>
							...
							<li style="margin-left:10px; margin-right:5px;">
								<?php if($message->from_id == $id): ?><?php echo  date_format($message->updated_at,'Y/m/d'). '->' . $message->post ?>
								<?php else: ?>
				...
				<div class="col-md-6">
					<div class="news-blocks lime">
						<div class="row">
							...
							<div>読Q資格・・・・・・・・・・・・・ <?php echo e($my_rank); ?>級、クイズ作成者<br></div>
				...
				<div class="col-md-6 column">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="<?php echo e(url('/mypage/wish_list/'.$user->id)); ?>">閲覧、編集画面へ</a>
						</div>
					</div>
						...
						<form class="form-horizontal" method="get" role="form" action="">
						 <input type="hidden" id="id" name="id" value="<?php echo e($id); ?>">
							<div class="news-blocks lime">
								...
								<p>
									<?php echo e($user->address2); ?><?php echo e($user->group_name); ?>児童の読書量・・・市で<?php echo e($school_rank_city); ?>位!
								</p>
								<div class="row">
									<div class="col-md-12">
				...
				<!-- 	<div class="row"> -->
					...
					<div class="news-blocks lime">
						...
						<table class="table table-no-border">
							<tr>
								<td class="col-md-8" ><a style="text-decoration:none;" href="<?php echo e(url('mypage/history_all/'.$user->id)); ?>">読Q活動の全履歴を見る</a></td>
								<td class="col-md-4">非公開</td>
							</tr>
							<tr>
								<td><a style="text-decoration:none;" href="<?php echo e(url('mypage/pass_history/'.$user->id)); ?>">合格履歴を見る</a></td>
							...
							<tr>
								<td><a style="text-decoration:none;" href="<?php echo e(url('mypage/rank_by_age/'.$user->id)); ?>">ポイントランキングを見る</a></td>
							...
							<tr>
								<td><a style="text-decoration:none;" href="<?php echo e(url('mypage/rank_bq/'.$user->id)); ?>">読書推進活動ランキングを見る</a></td>
							...
							<tr>
								<td><a style="text-decoration:none;" href="<?php echo e(url('mypage/book_reg_history/'.$user->id)); ?>">本の登録認定記録を見る</a></td>
							...
							<tr>
								<td><a style="text-decoration:none;" href="<?php echo e(url('mypage/quiz_history/'.$user->id)); ?>">作成クイズの認定記録</a></td>
							...
							<tr>
								<td><a style="text-decoration:none;" href="<?php echo e(url('mypage/last_report/0/'.$user->id)); ?>">読Qレポートバックナンバーを見る</a></td>
								<td>非公開</td>
							</tr>
							<tr>
								<td><a style="text-decoration:none;" href="<?php echo e(url('mypage/article_history/'.$user->id)); ?>">帯文投稿履歴を見る</a></td>
								<td>公開</td>
							</tr>
							<!-- <tr>
					...
					<div class="news-blocks lime">
						...
						<a href="<?php echo e(url('mypage/create_certi')); ?>" class="btn btn-warning offset-md-5" disabled="true">次　へ</a>
					</div>
					...
					<div class="news-blocks lime">
						...
						<a href="<?php echo e(url("/mypage/test_overseer")); ?>" class="btn btn-warning offset-md-2 <?php if($user->aptitude == 1 || $user->age() <= 20): ?> disabled <?php endif; ?>" style="margin-bottom:8px;" disabled="true">適性検査を受ける</a>
						<a href="<?php echo e(url("/mypage/oversee_test")); ?>" class="btn btn-warning <?php if($user->aptitude == 0 || $user::user()->age() <= 20): ?> disabled <?php endif; ?>" style="margin-bottom:8px;" disabled="true">試験監督を始める</a>
					</div>
				</div>
				...
				<div class="col-md-6 column">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body" style="height: 360px;">
							...
							<a class="text-md-center font-blue-madison" href="<?php if($user->isPupil()): ?><?php echo e(url('/mypage/rank_child_pupil/'.$user->id)); ?><?php else: ?><?php echo e(url('/mypage/rank_by_age')); ?><?php endif; ?>">もっと見る</a>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6 column">
					...
					<div class="news-blocks blue">
						...
						<a href="<?php echo e(url('/mypage/face_verify/1')); ?>" class="btn btn-warning offset-md-5" disabled="true">顔認証画面へ</a>
					</div>
					<?php endif; ?>
					<div class="news-blocks blue">
						...
						<a href="<?php echo e(url('/mypage/other_view_info')); ?>" class="btn btn-warning offset-md-1" style="margin-bottom:8px;" disabled="true">外部から見た基本情報を見る</a>
						<a href="<?php echo e(url('/mypage/face_verify/2')); ?>" class="btn btn-warning" style="margin-bottom:8px;" disabled="true">顔認証画面へ</a>
					</div>
